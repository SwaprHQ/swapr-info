...
import { DXD_ADDRESS, SWPR_ADDRESS, SupportedNetwork } from '../../constants/index';
...
const Inline = styled.div<{ flexBasis: string; justifyContent: string }>`
  display: flex;
  align-items: center;
  align-self: center;
...
export default function TokenLogo({
  ...
  const source = useMemo(() => {
    ...
    if (tokenIcon !== undefined && !badImages[tokenIcon]) return tokenIcon;
    return null;
