...
export default function ThemeProvider({ children }) {
  ...
  return <StyledComponentsThemeProvider theme={theme(darkMode, '#F7F8FA')}>{children}</StyledComponentsThemeProvider>;
}
...
type ThemedBackground = {
  backgroundColor: string;
};

export const ThemedBackground = styled.div<ThemedBackground>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
export const GlobalStyle = createGlobalStyle<{ theme: ReturnType<typeof theme> }>`
