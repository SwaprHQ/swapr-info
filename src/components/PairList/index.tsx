...
export default function PairList({ pairs, color, disbaleLinks, maxItems = 10 }: PairListProps) {
    ...
    Object.keys(pairs)
      .sort((addressA, addressB) => {
        ...
        if (sortedColumn === SORT_FIELD.APY) {
          const apy0 = (pairA.oneDayVolumeUSD * (pairA.swapFee / 10000) * 356 * 100) / parseFloat(pairA.reserveUSD);
          const apy1 = (pairB.oneDayVolumeUSD * (pairB.swapFee / 10000) * 356 * 100) / parseFloat(pairB.reserveUSD);
